...
XMLDoc::XMLDoc( bool processEntities, Whitespace whitespace ) :
    XMLNode( 0 ),
    _writeBOM( false ),
...
void XMLDoc::SetError( XMLError error, const char* str1, const char* str2 )
{
...
void XMLDoc::PrintError() const
{
    if ( Error() ) {
        ...
        printf( "XMLDoc error id=%d '%s' str1=%s str2=%s\n",
